    ...
    internal class Information
    {
        internal static void GetHelp()
        {
            Console.WriteLine("用法: " + Environment.NewLine +
                              "  wtgutil [/命令] [-参数]" + Environment.NewLine);
        ...
        {
            Console.WriteLine("WinToGo 实用工具 v3" + Environment.NewLine + "by Charles." + Environment.NewLine);
            Console.WriteLine("Github 存储库: https://github.com/Nothing9495/wtgutil" + Environment.NewLine);
            Console.WriteLine("上一次构建: 2022/11/20" + Environment.NewLine);
